<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default3.aspx.cs" Inherits="Antibiotic_Default3" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <caption class="auto-style2">  
                    <strong><asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/Antibiotic/Default.aspx"  >查詢頁面</asp:LinkButton></strong>  
            </caption> 
            </table>
