...
public partial class Default2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
           ...
           // loadGridData2();
            ...
            dt.Columns.AddRange(new DataColumn[7] { new DataColumn("Drg_ID"), new DataColumn("抗生素名稱"), new DataColumn("劑量"), new DataColumn("用法"), new DataColumn("開始日期"), new DataColumn("續用"), new DataColumn("預估停止日") });
            for (int i = 1; i <= 5; i++)
            {
                dt.Rows.Add(i, "", "");
            }
  ...
  /*  private void loadGridData()
    {        
        ...
        using (SqlConnection con = new SqlConnection(strConnString))
        {
            ...
            {
                cmd.CommandText = "SELECT TOP (5) Drog_info.Drg_ID, Drog_info.P_ID, Drog_info.Anti_name, Drog_info.Dose, Drog_info.Usage, Drog_info.Start_date, Drog_info.Con_usage, Drog_info.Stop_date FROM Drog_info INNER JOIN Patient_infor ON Patient_infor.P_ID = Drog_info.P_ID AND Patient_infor.P_Name = Drog_info.P_Name AND Drog_info.P_ID LIKE + @P_ID GROUP BY Drog_info.Drg_ID, Drog_info.P_ID, Drog_info.Anti_name, Drog_info.Dose, Drog_info.Usage, Drog_info.Start_date, Drog_info.Con_usage, Drog_info.Stop_date; ";
                cmd.Connection = con;
    ...
    protected void Button1_Click(object sender, EventArgs e) // INSERT Patient_infor
    {
        using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["DBConnection"].ConnectionString))
        {
            string Sex_Checked = ManCheckBox.Checked ? "1" : "0";
            string Age = TextBox30.Text;
            string P_bed = TextBox3.Text;
            string P_dr = TextBox4.Text;
            string P_ph = TextBox6.Text;
            string P_weight = TextBox7.Text;
            string P_creatin = TextBox8.Text;
            string P_bun = TextBox9.Text;
            string P_got = TextBox10.Text;
            string P_gpt = TextBox11.Text;
            string sql = "insert into [Patient_infor] ([P_ID], [P_Name], [P_Sex], [P_Age], [P_bed], [P_dr], [P_ph], [P_weight], [P_creatin], [P_bun], [P_got], [P_gpt], [Pa_Cre_Time]) values(@P_ID,@P_Name,@P_Sex,@P_Age,@P_bed,@P_dr,@P_ph,@P_weight,@P_creatin,@P_bun,@P_got,@P_gpt,@Pa_Cre_Time)";
            SqlCommand cmd = new SqlCommand(sql, conn);
            cmd.Parameters.Add("@P_ID", SqlDbType.NChar, 10).Value = this.TextBox1.Text;
            cmd.Parameters.Add("@P_Name", SqlDbType.NChar).Value = this.TextBox2.Text;
            ...
            cmd.Parameters.AddWithValue("@P_bed", P_bed);
            cmd.Parameters.AddWithValue("@P_dr", P_dr);
            cmd.Parameters.AddWithValue("@P_ph", P_ph);
            cmd.Parameters.AddWithValue("@P_weight", P_weight);
            cmd.Parameters.AddWithValue("@P_creatin", P_creatin);
            cmd.Parameters.AddWithValue("@P_bun", P_bun);
            cmd.Parameters.AddWithValue("@P_got", P_got);
            cmd.Parameters.AddWithValue("@P_gpt", P_gpt);
            cmd.Parameters.AddWithValue("@Pa_Cre_Time", DateTime.Now);
            //  cmd.Parameters.Add("@Stop_date", SqlDbType.DateTime).Value = this.TextBox16.Text;
            DataTable dt = new DataTable();
            using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
            {
                sda.Fill(dt);
    ...
    protected void btnSave_Click(object sender, EventArgs e)  // INSERT Drog_info
    {
        ...
        foreach (GridViewRow row in GridView3.Rows)
        {
            if (row.RowType == DataControlRowType.DataRow)
            {
                ...
                using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["DBConnection"].ConnectionString))
                {
                    string sql = "insert into [Drog_info] ([P_ID], [P_Name], [Anti_name], [Dose], [Usage], [Start_date], [Con_usage], [Stop_date], [Certification], [Drg_Cre_Time]) values(@P_ID,@P_Name,@Anti_name,@Dose,@Usage,@Start_date,@Con_usage,@Stop_date,@Certification,@Drg_Cre_Time)";
                    SqlCommand cmd = new SqlCommand(sql, conn);
                    cmd.Parameters.Add("@P_ID", SqlDbType.NChar, 10).Value = this.TextBox1.Text;
                    cmd.Parameters.Add("@P_Name", SqlDbType.NChar, 10).Value = this.TextBox2.Text;
                    ...
                    if(p_Anti_name.Text != null)
                    {
                        cmd.Parameters.Add("@Certification", SqlDbType.Bit).Value = false;
                    }
                    else
                    {
                        cmd.Parameters.Add("@Certification", SqlDbType.Bit).Value = "";
                    }
    ...
    {
        string p_Drg_ID = GridView1.DataKeys[e.RowIndex].Values["Drg_ID"].ToString();
        Label p_ID = (Label)GridView1.Rows[e.RowIndex].FindControl("txthpid");
        TextBox p_Anti_name = (TextBox)GridView1.Rows[e.RowIndex].FindControl("txtAnti_name");
        TextBox p_Dose = (TextBox)GridView1.Rows[e.RowIndex].FindControl("txtDose");
        TextBox p_Usage = (TextBox)GridView1.Rows[e.RowIndex].FindControl("txtUsage");
        TextBox p_Start_date = (TextBox)GridView1.Rows[e.RowIndex].FindControl("txtStart_date");
        TextBox p_Con_usage = (TextBox)GridView1.Rows[e.RowIndex].FindControl("txtCon_usage");
        TextBox p_Stop_date = (TextBox)GridView1.Rows[e.RowIndex].FindControl("txtStop_date");
        con.Open();
    ...
    /* protected void Button3_Click(object sender, EventArgs e)  // INSERT Drog_info
     {
         using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["DBConnection"].ConnectionString))
         {
             string sql = "insert into [Drog_info] ([P_ID], [P_Name], [Anti_name], [Dose], [Usage], [Start_date], [Con_usage], [Stop_date]) values(@P_ID,@P_Name,@Anti_name,@Dose,@Usage,@Start_date,@Con_usage,@Stop_date)";
             SqlCommand cmd = new SqlCommand(sql, conn);
             cmd.Parameters.Add("@P_ID", SqlDbType.NChar, 10).Value = this.TextBox1.Text;            
             cmd.Parameters.Add("@P_Name", SqlDbType.NChar, 10).Value = this.TextBox2.Text;            
             cmd.Parameters.Add("@Anti_name", SqlDbType.NVarChar, 50).Value = this.TextBox12.Text;
             cmd.Parameters.Add("@Dose", SqlDbType.NVarChar, 50).Value = this.TextBox13.Text;
             cmd.Parameters.Add("@Usage", SqlDbType.NVarChar, 50).Value = this.TextBox14.Text;
             cmd.Parameters.Add("@Start_date", SqlDbType.NVarChar, 50).Value = this.TextBox29.Text;
             cmd.Parameters.Add("@Con_usage", SqlDbType.NVarChar, 50).Value = this.TextBox15.Text;
             cmd.Parameters.Add("@Stop_date", SqlDbType.NVarChar, 50).Value = this.TextBox16.Text;
             // cmd.Parameters.AddWithValue("@Drg_Cre_Time", DateTime.Now);
             DataTable dt = new DataTable();
             using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
             {
  ...
  /*  protected void Submit()  //Submit CheckBox "check" or "not check"
    {
      //  Singo Q
       // string relocate = Q1CheckBox.Checked ? "1" : "0";
        string relocate1 = Q1CheckBox.Checked ? "1" : "0";
        string relocate1_1 = Q1_1CheckBox.Checked ? "1" : "0";
        string relocate2 = Q2CheckBox.Checked ? "1" : "0";
        string relocate6 = Q6CheckBox.Checked ? "1" : "0";
        string relocate7 = Q7CheckBox.Checked ? "1" : "0";
        string relocate8 = Q8CheckBox.Checked ? "1" : "0";
        string relocate9 = Q9CheckBox.Checked ? "1" : "0";
        string relocate10 = Q10CheckBox.Checked ? "1" : "0";
        string relocate11 = Q11CheckBox.Checked ? "1" : "0";
        string relocate12 = Q12CheckBox.Checked ? "1" : "0";
        string relocate13 = Q13CheckBox.Checked ? "1" : "0";
        string relocate14 = Q14CheckBox.Checked ? "1" : "0";
        string relocate15 = Q15CheckBox.Checked ? "1" : "0";
        string relocate18 = Q18CheckBox.Checked ? "1" : "0";
        //Muti Q
        string relocate3 = Q3CheckBox.Checked ? "1" : "0";
        string relocate3_1 = Q3_1CheckBox.Checked ? "1" : "0";
        string relocate3_2 = Q3_2CheckBox.Checked ? "1" : "0";
        string relocate3_3 = Q3_3CheckBox.Checked ? "1" : "0";
        string relocate4 = Q4CheckBox.Checked ? "1" : "0";
        string relocate4_1 = Q4_1CheckBox.Checked ? "1" : "0";
        string relocate4_2 = Q4_2CheckBox.Checked ? "1" : "0";
        string relocate4_3 = Q4_3CheckBox.Checked ? "1" : "0";
        string relocate5 = Q5CheckBox.Checked ? "1" : "0";
        string relocate5_1 = Q5_1CheckBox.Checked ? "1" : "0";
        string relocate5_2 = Q5_2CheckBox.Checked ? "1" : "0";
        string relocate5_3 = Q5_3CheckBox.Checked ? "1" : "0";
        string relocate12_1 = Q12_1CheckBox.Checked ? "1" : "0";
        string relocate12_2 = Q12_2CheckBox.Checked ? "1" : "0";
        string relocate12_3 = Q12_3CheckBox.Checked ? "1" : "0";
        string relocate12_4 = Q12_4CheckBox.Checked ? "1" : "0";
        string relocate16 = Q16CheckBox.Checked ? "1" : "0";
        string relocate16_1 = Q16CheckBox.Checked ? "1" : "0";
        string relocate16_2 = Q16CheckBox.Checked ? "1" : "0";
        string relocate16_3 = Q16CheckBox.Checked ? "1" : "0";
        
        string relocate17 = Q17CheckBox.Checked ? "1" : "0";
        string relocate17_1 = Q17_1CheckBox.Checked ? "1" : "0";
        string relocate17_2 = Q17_2CheckBox.Checked ? "1" : "0";
        string relocate17_3 = Q17_3CheckBox.Checked ? "1" : "0";
        string relocate17_4 = Q17_4CheckBox.Checked ? "1" : "0";
        string relocate19 = Q19CheckBox.Checked ? "1" : "0";
        string relocate20 = Q20CheckBox.Checked ? "1" : "0";

        string constr = ConfigurationManager.ConnectionStrings["DBConnection"].ConnectionString;
        using (SqlConnection con = new SqlConnection(constr))
        {
            using (SqlCommand cmd = new SqlCommand("INSERT INTO [Antibiotic] ([Q_P_ID], [Q1_1], [Q1_2], [Q2], [Q2_1], [Q2_2], [Q3], [Q3_1], [Q3_2], [Q3_3], [Q4], [Q4_1], [Q4_2], [Q4_3], [Q5], [Q5_1], [Q5_2], [Q5_3], [Q6], [Q7], [Q8], [Q9], [Q10], [Q11], [Q11_t], [Q12], [Q12_t], [Q12_1], [Q12_2], [Q12_3], [Q12_4], [Q13], [Q13_t], [Q13_1], [Q14], [Q15], [Q16], [Q16_1], [Q16_1_t], [Q16_2], [Q16_3], [Q16_3_t], [Q17], [Q17_1], [Q17_2], [Q17_3], [Q17_4], [Q18], [Q19], [Q19_1], [Q19_2], [Q19_3], [Q20], [Q20_1]) VALUES(@Q_P_ID,@Q1_1, @Q1_2, @Q2, @Q2_1, @Q2_2, @Q3, @Q3_1, @Q3_2, @Q3_3, @Q4, @Q4_1, @Q4_2, @Q4_3, @Q5, @Q5_1, @Q5_2, @Q5_3, @Q6, @Q7, @Q8, @Q9, @Q10, @Q11, @Q11_t, @Q12, @Q12_t, @Q12_1, @Q12_2, @Q12_3, @Q12_4, @Q13, @Q13_t, @Q13_1, @Q14, @Q15, @Q16, @Q16_1, @Q16_1_t, @Q16_2, @Q16_3, @Q16_3_t, @Q17, @Q17_1, @Q17_2, @Q17_3, @Q17_4, @Q18, @Q19, @Q19_1, @Q19_2, @Q19_3, @Q20, @Q20_1)"))
            {
                cmd.Connection = con;
                cmd.Parameters.Add("@Q_P_ID", SqlDbType.NChar, 10).Value = this.TextBox1.Text;
                ...
                {
                    cmd.Parameters.Add("@Q4", SqlDbType.NChar, 10).Value = "0";
               ...
               // cmd.Parameters.AddWithValue("@Q13_1", relocate30);
                ...
                else
                {
                    ...
                    cmd.Parameters.Add("@Q19_1", SqlDbType.NVarChar, 50).Value = "0";
                    cmd.Parameters.Add("@Q19_2", SqlDbType.NVarChar, 50).Value = "0";
                    cmd.Parameters.Add("@Q19_3", SqlDbType.NVarChar, 50).Value = "0";
                }
                ...
                else
                {
                    ...
                    cmd.Parameters.Add("@Q20_1", SqlDbType.NVarChar, 50).Value = "0";
                }
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
    ...
    public void SubmitAndcreatPDF()
    {
        ...
        using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["DBConnection"].ConnectionString))
        {
            ...
            string sql = "insert into [PDF_info] ([P_ID], [P_Name], [PDF_CreTime], [PDF_Path]) values(@P_ID,@P_Name,@PDF_CreTime,@PDF_Path)";
            {
                SqlCommand cmd = new SqlCommand(sql, conn);
                cmd.Parameters.Add("@P_ID", SqlDbType.NChar, 10).Value = this.TextBox1.Text;
                cmd.Parameters.Add("@P_Name", SqlDbType.NChar, 10).Value = this.TextBox2.Text;
      ...
      //  Response.AddHeader("content-disposition", "attachment;filename=TestPage.pdf");
        ...
        for (int j = 0; j < 5; j++)
        {
            for (int k = 0; k < 6; k++)
            {
                Grid_Output.Rows[j].Cells[k].Text = Grid_Output.Rows[j].Cells[k].Text.Replace("&nbsp;", " ");
                ptb.AddCell(new Phrase(Grid_Output.Rows[j].Cells[k].Text, fontCh));
            }
         }
        ...
        Q21_1.Add(new Chunk(image3, -35, -840));
    ...
    /*doc1.Add(table9);*/         doc1.Add(table10);        doc1.Add(table11);        doc1.Add(table12);        doc1.Add(table13);
    ...
    /*doc1.Add(table24);*/        doc1.Add(table25);        doc1.Add(table26);        doc1.Add(table27);        doc1.Add(table28);
   ...
   /* protected void Submit(object sender, EventArgs e)
    ...
    /*protected void creatPDF(object sender, EventArgs e)
    {
        creatPDF();
          ClearControlValue(TextBox1, TextBox2, TextBox3, TextBox4, TextBox5,
                            ...
                            Q1CheckBox, Q1_1CheckBox, Q2CheckBox, Q3CheckBox, Q3_1CheckBox, Q3_2CheckBox, Q3_3CheckBox,
                            Q4CheckBox, Q4_1CheckBox, Q4_2CheckBox, Q4_3CheckBox, Q5CheckBox, Q5_1CheckBox, Q5_2CheckBox,
                            Q5_3CheckBox, Q6CheckBox, Q7CheckBox, Q8CheckBox, Q9CheckBox, Q10CheckBox, Q11CheckBox,
                            Q12CheckBox, Q12_1CheckBox, Q12_2CheckBox, Q12_3CheckBox, Q12_4CheckBox, Q13CheckBox, Q14CheckBox,
                            Q15CheckBox, Q16CheckBox, Q16_1CheckBox, Q16_2CheckBox, Q16_3CheckBox, Q17CheckBox, Q17_1CheckBox,
                            Q17_2CheckBox, Q17_3CheckBox, Q17_4CheckBox, Q18CheckBox, Q19CheckBox, Q20CheckBox);
    }*/
