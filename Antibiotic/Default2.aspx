...
<body>
    ...
    <form id="form1" runat="server">
        <div class="auto-style1">
            <table  class="auto-style20" >
                <tr style="border:3px #cccccc solid;">
                    ...
                    <td class="auto-style29" aria-multiline="True">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ForeColor ="Red" ControlToValidate ="TextBox2" Display="Dynamic"></asp:RequiredFieldValidator>
                    </td>
                    ...
                    <td class="auto-style4" aria-multiline="True">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ForeColor ="Red" ControlToValidate ="TextBox30" Display="Dynamic"></asp:RequiredFieldValidator>
                    </td>
                    <td class="auto-style47"  bgcolor="#4279bd" style=" color:White;" aria-multiline="True">病歷號碼:</td>
                    <td class="auto-style4" aria-multiline="True">
                        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="請輸入0-9的數字" ForeColor="Red" ControlToValidate="TextBox1" ValidationExpression="^\d{0,8}" Display="Dynamic"></asp:RegularExpressionValidator>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ForeColor ="Red" ControlToValidate ="TextBox1" Display="Dynamic"></asp:RequiredFieldValidator>
                    </td>
            ...
            <asp:Button ID="Button1" runat="server" Text="新增基本資料" OnClick="Button1_Click" Width="100px" />             
            <asp:GridView ID="GridView1" 
                ...
                <asp:TemplateField>
                        <EditItemTemplate>
                            <asp:Button ID="ButtonUpdate" runat="server" CommandName="Update" Text="更新" />
                            <asp:Button ID="ButtonCancel" runat="server" CommandName="Cancel" Text="取消" />
                        </EditItemTemplate>
                        <ItemTemplate>
                            <asp:Button ID="ButtonEdit" runat="server" CommandName="Edit" Text="編輯"/>                            
                            <asp:Button ID="ButtonDelete" runat="server" CommandName="Delete" Text="刪除" />                           
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            ...
            <asp:GridView ID="GridView3" runat="server" 
                ...
                Visible="True" >
                  <Columns>
                    <asp:TemplateField HeaderText="ID">
                        <ItemTemplate>
                            <asp:Label ID="lblDrg_ID" runat="server" Text='<%# Eval("Drg_ID") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="抗生素名稱">
                        <ItemTemplate>
                            <asp:TextBox ID="txtAnti_name" runat="server" width="100px" ></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="劑量">
                        <ItemTemplate>
                            <asp:TextBox ID="txtDose" runat="server" width="100px"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="用法">
                        <ItemTemplate>
                            <asp:TextBox ID="txtUsage" runat="server" width="100px"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="開始日期">
                        <ItemTemplate>
                            <asp:TextBox ID="txtStart_date" runat="server" class = "Calender" width="100px"></asp:TextBox>
                            <img src="images/calender.png" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="續用">
                        <ItemTemplate>
                            <asp:TextBox ID="txtCon_usage" runat="server" width="100px"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                      <asp:TemplateField HeaderText="預估停止日">
                        <ItemTemplate>
                            <asp:TextBox ID="txtStop_date" runat="server" class = "Calender" width="100px"></asp:TextBox>
                            <img src="images/calender.png" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
             ...
             <asp:GridView ID="Grid_Output"  AutoGenerateColumns="false"  runat="server" Visible="false">
                <Columns>
            ...
            <asp:Button ID="btnSave" runat="server" Text="新增藥品資料" OnClick="btnSave_Click" Width="100px" />
            <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <br />
            <asp:Button ID="Button4" runat="server" Text="送出資料並另存成PDF" OnClick="Button4_Click" />
            <asp:Button ID="Button7" runat="server"  Text="查詢資料" OnClientClick = "window.open('Default.aspx');" />
            <asp:Button ID="cmdExit" runat="server" Text="離開" onClientClick="WinClose();"  ForeColor="#003399" Font-Size="Large" Font-Bold="true" CssClass="ButtonClass" />
                    <script>
                        function WinClose() {
                            window.open('', '_self', '');
